      ...
      <TouchableOpacity onPress={onPress} >
        <View style={[ms.row, ms.card]}>
            <View style={[[ms.width('20%')]]}>
                <Image source={paket?.image} style={[ms.wh('100%', 52)]}/>
            </View>
            <View style={[[ms.width('80%'), ms.pdV(10)]]}>
                ...
                <View style={[ms.row]}>
                    <View style={[ms.width('40%')]}>
                      <Text style={[ms.fzBCLh(10,'400','#000000',12)]}><Image source={IconVerifikasi} style={[ms.wh(11,11)]}/> {paket?.toko_name}</Text>
                    </View>
                ...
                <View style={[ms.row]}>
                    <View style={[ms.width('50%')]}>
                      <Text style={[ms.fzBCLh(10,'700','#FFAA00',12)]}> Rp. {paket?.biaya}</Text>
                    </View>
