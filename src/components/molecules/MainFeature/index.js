...
const MainFeature = ({img, onPress, title,fontSize=11, width='22%', height, widthImg=40, heightImg=40,backgroundColor=colors.navigate}) => {
   return (
      <TouchableOpacity onPress={onPress} style={styles.container(width,height,widthImg,heightImg)}>
        
              <View style={styles.vImg(widthImg, heightImg)}>
                    {
                      img && (
